...
import { AddClinicAPI, adminUpdateClinicByIdAPI, getClinicAPI, getClinicByUserIDAPI } from '../controller/Clinic.controller.js';
...
clinicRoutes.put("/admin/update-clinic/:clinicId",checkAuthentication,  uploadSingle.single("profileimg"), adminUpdateClinicByIdAPI);
